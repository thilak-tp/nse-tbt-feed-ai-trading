...
class Logger {
  ...
  public:
    ...
    Logger(LogLevel level , const std::string& filename = defaultFilename): minLevel(level) {
      ...
      if (!fileToOpen.empty()) {
        ...
        //std::cout<<"The file "<<fileToOpen<<" is opened!"<<std::endl;
      }
      else {
...
/*
    ...
    static LogLevel Logger::getGlobalLogLevel() {
    // To get the static log fileanme;
    static std::string getGlobalFilename();
*/
